...
public class JavaCode {
	...
	static final String NICKNAME = "서울14_정유경";
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (socket != null) {
				...
				float targetBall_x = balls[ballnum][0];
				float targetBall_y = balls[ballnum][1];
...
//				4사분면
				...
				power = (float) ((len * 0.5 + distance * 0.5)*0.5);
